...
def test_chat_endpoint_empty_payload(test_client):
    """Verify validation handling for empty query input."""
    response = test_client.post("/api/v1/chat", json={"question": "", "session_id": "test_session"})
...
def test_chat_endpoint_multi_turn_memory(test_client):
    ...
    resp1 = test_client.post("/api/v1/chat", json=turn1_payload)
    ...
    resp2 = test_client.post("/api/v1/chat", json=turn2_payload)
